...
<html lang="et">
    ...
    <body>
        ...
        <h1>Funktisoonid</h1>
        <?php
        //funktsiooni loomine, vaikimis atribuudiga (anonüümne)
    ...
    echo "<br>--------------<br>";
        ...
        <h1>Massiivid</h1>
    <?php
        $nimed = array('mari', 'kati', 'juhan', 'miku', 'uku', 'maali','tuuli','sepp');    
        sort($nimed);
       // print_r($nimed);
        ...
        echo"--------------<br>";
        $counter = 0;                   //loeb nimesi
        foreach ($nimed as $nimi) {
            echo"$nimi<br>";        
            $counter++;                  //igakord kui nimi ++ ütleb counter-ile +1 nimi
           if ($counter==3) {
                break;
           }
        }
        ...
        echo "---------------<br>";
        echo "Suvaline nimi: " .$nimed[array_rand($nimed)]. "<br>"      //array_rand($nimed) annab suvalise numbri, $nimed[......] annab numbrikohal nime.
...
echo"Autsid massivis ". count($cars);
echo "<br>--------------<br>";
...
echo "Toyota-sid on: $toyota <br>Audi-si on: $audi"; 
echo "<br>--------------<br>";
foreach ($vins as $vin) {
    if (strlen($vin)<17) {
        echo "$vin<br>";
